(function (angular) {
    ...
    function surveySettings(CommunicationService, $q, Enums) {
        ...
        vm.ChangeArrowPosition = changeArrowPosition;
        ...
        function setProperties(backColor, backImage, buttonColor, buttonTxtColor, textColor, optionColor, sectionHeaderColor, sectionFooterColor, text, quesFont, ansFont, btnFont, quesFontSize, ansFontSize, btnFontSize, progressBarBgColor, progressColor, progressTextColor, answerSelectionColor, answerSelectionBg, smileyColor, themeTitle, optionBgColor, optionBorderColor, starColor, starSelectionColor, submitTextColor, submitBgColor, npsBackground, npsBorder, npsText, npsBorderWidth) {
            ...
            if (npsBackground != undefined) {
                vm.Settings.CSSProperties.NPSBackground = npsBackground;
            }
            if (npsBorder != undefined) {
                vm.Settings.CSSProperties.NPSBorder = npsBorder;
            }
            if (npsText != undefined) {
                vm.Settings.CSSProperties.NPSText = npsText;
            }
            if (npsBorderWidth != undefined) {
                vm.Settings.CSSProperties.NPSBorderWidth = npsBorderWidth;
            }
        }
        ...
        function getNPSBackgroundColor() {
            return vm.Settings.CSSProperties.NPSBackground;
        }
        function getNPSBorderColor() {
            return vm.Settings.CSSProperties.NPSBorder;
        }
        function getNPSTextColor() {
            return vm.Settings.CSSProperties.NPSText;
        }
        function getNPSBorderWidth() {
            return vm.Settings.CSSProperties.NPSBorderWidth;
        }
        ...
        function setSurveyProperties(prop, isPreview) {
            ...
            vm.ArrowPosition = surveyProperties.ArrowPosition;
        ...
        function applyChanges() {
            ...
            try {
                if (cssProperties.BackgroundColor != '') {
                    applyCSSProperties('#page,.modal-body,.survey-bottomHdr', 'background-color: ' + cssProperties.BackgroundColor);
                    applyCSSProperties('.form-checkbox input:checked+.form-icon::before,.imgOption li .icon-check:before', 'border-color: ' + (cssProperties.BackgroundColor) + '!important');
                ...
                if (cssProperties.ButtonsColor != '') {
                    applyCSSProperties('.prev-next,.captureMediaBtn,.btnOTP,.button.nav,.button.general,.footerLinks li a,.start-up-wrapper .prev-next', 'background-color: ' + (cssProperties.ButtonsColor) + '!important;');
                }
                if (cssProperties.ButtonsTxtColor != '') {
                    applyCSSProperties('.prev-next,.captureMediaBtn,.btnOTP,.button.nav,.button.general,.start-up-wrapper .prev-next', 'color: ' + (cssProperties.ButtonsTxtColor) + '!important;');
                ...
                if (cssProperties.OptionTextColor != '') {
                    ...
                    applyCSSProperties('.none-div:hover,.btn.btn-primary', 'background-color: ' + hex2rgb(cssProperties.OptionTextColor, .2) + '!important');
                ...
                if (cssProperties.QuesFont != '') {
                    applyCSSProperties('#page,#page option,#page input[type="text"]', 'font-family: ' + cssProperties.QuesFont + '!important');
                }
                if (cssProperties.AnsFont != '') {
                    applyCSSProperties('.option-as-label,#blinkingHint,textarea,.button.navend,.ratingCircle-txt,.nps-box', 'font-family: ' + cssProperties.AnsFont + '!important');
                }
                ...
                if (cssProperties.QuesFontSize != '') {
                    applyCSSProperties('#page,#page option,#page input[type="text"]', 'font-size: ' + cssProperties.QuesFontSize + 'px!important');
                }
                ...
                if (cssProperties.QuestionTextColor != '') {
                    applyCSSProperties('.sq-text,.sq-name,.section-header', 'color: ' + (cssProperties.QuestionTextColor) + '!important');
                }
                ...
                if (cssProperties.AnswerSelectionBg != '') {
                    ...
                    applyCSSProperties('.none-div-background', 'background-color: ' + (cssProperties.AnswerSelectionBg) + '!important');
                    applyCSSProperties('.form-checkbox input:checked + .form-icon', 'border-color: ' + (cssProperties.AnswerSelectionBg) + '!important');
                    applyCSSProperties('.form-checkbox input:checked + .form-icon', 'background-color:' + (cssProperties.AnswerSelectionBg) + '!important;opacity:0.7!important');
                    ...
                    applyCSSProperties('.option-checked .bg:hover', 'background-color:' + hex2rgb(cssProperties.AnswerSelectionBg) + '!important;opacity:1!important');
                }
                if (cssProperties.AnswerSelectionColor != '') {
                    applyCSSProperties('.option-checked .survey-option-text,.option-checked .icon-check,.nps-background,.none-div-background', 'color: ' + (cssProperties.AnswerSelectionColor) + '!important');
                ...
                if (cssProperties.StarSelectionColor != '') {
                    ...
                    applyCSSProperties('.svg-filled.npsCircle circle', 'fill: ' + (cssProperties.StarSelectionColor) + '!important');
                    applyCSSProperties('.nps-star:hover .stkv-us-secondary--fill', 'fill:' + hex2rgb(cssProperties.StarSelectionColor,.4) + '!important;opacity:1!important');
                    applyCSSProperties('.ratingShape:hover .npsCircle circle', 'stroke:' + hex2rgb(cssProperties.StarSelectionColor,.4) + '!important;');
                }
                ...
                if (cssProperties.NPSBackground != '') {
                    ...
                    applyCSSProperties('.nps-box:hover', 'background-color: ' + (cssProperties.NPSBackground,.2) + '!important');
                }
                if (cssProperties.NPSBorder != '') {
                    applyCSSProperties('.nps-box.nps-background', 'border-color: ' + (cssProperties.NPSBorder) + '!important;z-index:inherit!important;');
                }
                if (cssProperties.NPSText != '') {
                    applyCSSProperties('.nps-box.nps-background', 'color: ' + (cssProperties.NPSText) + '!important');
                }
                if (cssProperties.NPSBorderWidth != '') {
                    applyCSSProperties('.nps-box .bg,.nps-box.nps-background', 'border-width: ' + (cssProperties.NPSBorderWidth) + 'px!important');
                }
            } catch (e) {
                console.error(e);
            }
        ...
        function changeArrowPosition() {
            surveyProperties.ArrowPosition = vm.ArrowPosition;
            updateSurveyProperties();
        }
